...
const styles = {
  ...
  title: { color: '#e8e8e8', fontSize: 26, fontWeight: 700, margin: 0, textAlign: 'center', letterSpacing: '-0.5px' },
  subtitle: { color: '#666', fontSize: 13, textAlign: 'center', marginTop: 6, marginBottom: 24 },
  tabRow: { display: 'flex', marginBottom: 20, borderBottom: '1px solid #252525' },
  tab: { flex: 1, background: 'none', border: 'none', color: '#555', padding: '8px 0', cursor: 'pointer', fontSize: 14 },
  ...
  input: { background: '#161616', border: '1px solid #252525', borderRadius: 8, padding: '11px 14px', color: '#e8e8e8', fontSize: 14, outline: 'none' },
